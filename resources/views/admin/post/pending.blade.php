                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($post->is_approved==false)
                                                 ...
                                                 <button href="" type="button" class="btn btn-danger waves-effect" onclick="approvePost({{ $post->id }})">
                                                <i class="material-icons">pending</i></button>
                                                <form id="APPRV-form{{ $post->id }}" action="{{ route('admin.post.approve',$post->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('PUT')
                                                </form>
                                                 @endif
                                                ...
                                                <button href="" type="button" class="btn btn-danger waves-effect" onclick="deletepost({{ $post->id }})">
...
@push('js')
  ...
  if (result.value) {
    event.preventDefault();
    document.getElementById('APPRV-form'+id).submit();
